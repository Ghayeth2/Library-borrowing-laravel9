...
<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a  href="{{route('Admin.borrowm.index')}}"><i class="icon-arrow-right" style="color: whitesmoke"></i>
            ...
            <li><a href="{{route('Admin.faq.index')}}" ><i class="icon-question"></i><span
           ...
           <!-- <li class="nav-label"></li>-->
            ...
            <li><a  href="{{route('Admin.setting')}}" ><i
