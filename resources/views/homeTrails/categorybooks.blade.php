                                    ...
                                    <article>
                                        ...
                                        <div class="single-book-box">
                                            <div class="post-thumbnail">
                                                ...
                                                <a href="{{route('book',['id'=>$row->id])}}"><img alt="Book" src="{{\Illuminate\Support\Facades\Storage::url($row->image)}}"
                                                    style="width: 260px; height: 414px;"/></a>                                                                 </div>
                                            <div class="post-detail">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <h3 class="entry-title">
                                                                <a href="books-media-detail-v1.html">{{$row->title}}</a>
                                                            </h3>
                                                            <ul>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <ul>
                                                                <li><strong>Edition:</strong> {{$row->edition}}</li>
                                                                <li>
                                                                    <div class="rating">
                                                ...
                                                <footer class="entry-footer">
                                                    <a class="btn btn-dark-gray" href="books-media-detail-v1.html">See More</a>
                                                </footer>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
