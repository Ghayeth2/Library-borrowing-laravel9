...
@section('slider')
        @include('homeTrails.user.mayborrowsBanner')
@endsection
                                                                ...
                                                                <tr class="cart_item">
                                                                    ...
                                                                    <td data-title="Product" class="product-name">
                                                                            <span class="product-thumbnail">
                                                                                <a href="#"><img alt="{{$row->book->title}}" src="{{\Illuminate\Support\Facades\Storage::url($row->book->image)}}"
                                                                                                 style="width: 100px; height: 111px; "/></a>
                                                                            </span>
                                                                        <span class="product-detail">
                                                                                <a href="#"><strong>{{$row->book->title}}</strong></a>
                                                                                <span><strong>Author:</strong> {{$row->book->author}}</span>
                                                                                <span><strong>ISBN:</strong> {{$row->book->isbn}}</span>
                                                                            </span>
                                                                    </td>
                                                                    <td data-title="action" class="product-action">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                ...
                                                                                <li><a href="{{route('destroyborrowbook',['id'=>$row->id])}}">Cancel Hold</a></li>
                                                                    ...
                                                                    <td data-title="Price" class="product-price">
                                                                       <span class="product-detail">
                                                                                <span><strong>Taking Date : </strong> {{$row->bookdate}}</span>
                                                                                <span><strong>Return Date : </strong> {{$row->returndate}}</span>
